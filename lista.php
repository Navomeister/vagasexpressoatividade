<?php
    ...
    include_once('conexao.php');
                    ...
                    $result_usuarios = "SELECT * FROM veiculo WHERE estacionado = 1 LIMIT $inicio, $qnt_result_pg";
                    $resultado_usuarios = mysqli_query($conn, $result_usuarios);

                    echo("<br><a href='index_placa.php'>Cadastrar Placa</a> <br>");
                    echo("<a href='lista_sairam.php'>Carros não estacionados</a> <br>");
                    ...
                    while ($row_usuario = mysqli_fetch_assoc($resultado_usuarios)){
                        ...
                        echo "<p>Horario de Entrada: " . $row_usuario['horario_entrada'] . "</p>";
                        echo "<a href='./pagamento.php?id=" . $row_usuario['id'] . "'>Sair do Estacionamento</a>";
                    }

                    // Paginação - Somar a quantidade de usuários
                    $result_pg = "SELECT COUNT(id) AS num_result FROM veiculo WHERE estacionado = 1";
                    ...
                    $max_links = 2;
                    echo '<br><br><a href="./lista.php?pagina=1">Primeira</a> ';
